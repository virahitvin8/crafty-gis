...
CRAFTY GIS is an **open-source, AI-powered geospatial intelligence platform** that makes satellite data analysis accessible to everyone. We welcome contributions from everyone — whether you're a GIS professional, a remote sensing researcher, a Python/TypeScript developer, a UI/UX designer, or someone passionate about making Earth observation data accessible to all.

## Code of Conduct

This project and everyone participating in it is governed by our [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [akshitvinay4636@gmail.com](mailto:akshitvinay4636@gmail.com).
...
Enhancement suggestions are tracked as [GitHub issues](https://github.com/virahitvin8/crafty-gis/issues).
...
- Considered for maintainer roles based on contribution quality
